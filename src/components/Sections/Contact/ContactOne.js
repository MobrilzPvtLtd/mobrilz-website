                ...
                <div className="lg:flex items-center justify-between">
                    <div className="content-main w-full xl:w-7/12 lg:w-1/2 text-white">
                        ...
                        <div className="flex items-center mt-6">
                            ...
                            <span className="body2 pl-3">sales@mobrilz.com</span>
                        </div>
                        <div className="flex items-center mt-2">
                            <Icon.PhoneCall className="text-xl" />
                            <span className="body2 pl-3"> + 1 (256) 854-2032</span>
                        </div>
                        <div className="flex items-center mt-2">
                            <Icon.MapPin className="text-xl" />
                            <span className="body2 pl-3">E-38, 2nd Floor, Sector 63 Noida, U.P. 201301, India</span>
                        </div>
                        <Link href={'https://maps.app.goo.gl/CKkyfP2raz7wseDq9'} target='_blank' className='inline-block underline mt-2'>Open map</Link>
                    </div>
                    <div className="w-full xl:w-1/3 lg:w-[40%] max-lg:mt-10">
                        <div className="form-block rounded-2xl bg-white py-6 px-7 flex flex-col gap-5">
                            <div className="heading5">Get A Quote</div>
