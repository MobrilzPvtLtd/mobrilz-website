...
const SliderTwo = () => {
  ...
  return (
    <>
      <section className="slider style-two w-full  mb-5 ">
            ...
            <SwiperSlide>
              <div className="slider-item  w-full relative">
                <div className="container w-full h-full flex items-center">
                  ...
                  <div className="sub-img absolute left-0 top-0 w-full  z-[-1] bg-gradient-to-r from-darkBlue to-mediumBlue h-full flex justify-end items-center">
                    <Image
